...
import 'package:pawnav/features/editPost/presentation/widget/edit_photo_picker.dart';
...
class _EditPostFormPageState extends State<EditPostFormPage> {
  ...
  //Backend'den gelen mevcut fotoğraflar
  List<String> existingImageUrls = [];

  //Kullanıcının edit sırasında ekledikleri
  List<XFile> selectedImages = [];

  //Silinen eski fotoğraflar (backend için)
  ...
  void initState() {
    ...
    animalNameController.addListener(_markAsChanged);
    descriptionController.addListener(_markAsChanged);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocListener<EditPostCubit, EditPostState>(
        ...
        child: BlocBuilder<EditPostCubit, EditPostState>(
          builder: (context, state) {
            if (state is EditPostLoading || state is EditPostSaving) {
            ...
            final effectiveLocation = editedLocation ?? post.location;


            if (!_isFormInitialized) {
              animalNameController.text = post.name ?? "";
              descriptionController.text = post.description ?? "";

              selectedSpecies = post.species;
              selectedBreed = post.breed;
              selectedColor = post.color;

              selectedDate = post.eventDate;
              selectedGender = post.gender;
                    ...
                    TextButton(
                      onPressed: _hasChanges
                          ? () {
                              ...
                              context.read<EditPostCubit>().save(
                                    updatedPost,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(10, 4, 16, 4),
                                child: Row(
                                  mainAxisAlignment:
                                  ...
                                  Positioned(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        print("MAP RESULT: $result (${result.runtimeType})");
                          ...
                          child: Column(
                            ...
                            children: [
                              EditPhotoPicker(
                                ...
                                networkImages: existingImageUrls,
                                localImages: selectedImages,
                                onAdd: () => addPhoto(context),
                                onRemoveLocal: removePhoto,
                                onRemoveNetwork: (index) {
                                  setState(() {
                                    removedImageUrls
                                        .add(existingImageUrls[index]);
